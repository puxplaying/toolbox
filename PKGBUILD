...
arch=(any)
url="https://github.com/puxplaying/toolbox/" # By changing this to "https://github.com/Chrysostomus/toolbox" you should be able to release packages on your Github fork!
license=('GPL3')
